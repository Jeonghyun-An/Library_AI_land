<template>
  ...
  <div class="contents_wrap" id="contents_wrap">
    ...
    <!-- [E] left_menu_wrap -->
    <!-- [S] search_wrap -->
    <div class="search_wrap search_main_wrap">
      ...
      <div class="search_main">
        <div class="inner">
          ...
          />
          <div class="main_txt">
            사용자에 질문에 신뢰할 수 있는 도서정보를 기반으로한
            국립중앙도서관의 생성형 인공지능 서비스입니다.
          </div>
...
definePageMeta({
  layout: "search",
  layoutProps: { wrapClass: "search_wrap search_main_wrap" },
});
useHead({ title: "AI 도서정보 검색시스템" });
</script>
